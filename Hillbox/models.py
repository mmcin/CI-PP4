...
# this is where I will store the flying sites that user uploads I based
# this model on the model from the CI blog post with the obvious changes
# such as adding choices for the wind direction
...
class Photo(models.Model):
    ...
    uploaded_by = models.ForeignKey(
        User, on_delete = models.CASCADE, related_name = "photo")
    site_name = models.CharField(max_length = 150, unique = True)
...
# this is the model for the comments related to the gallery photos
